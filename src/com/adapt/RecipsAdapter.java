...
public class RecipsAdapter extends ArrayAdapter<RecipesContent> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		LinearLayout layout;
		if (convertView == null)
			layout = (LinearLayout) infl.inflate(textviewResourceId, parent,
					false);
		else
			layout = (LinearLayout) convertView;
		final TextView name = (TextView) layout.findViewById(R.id.title);
		final TextView lvlText = (TextView) layout.findViewById(R.id.leveltxt);
		final ImageView lvlImg = (ImageView) layout.findViewById(R.id.levelimg);
		final TextView costText = (TextView) layout.findViewById(R.id.couttxt);
		final ImageView costImg = (ImageView) layout.findViewById(R.id.coutimg);
