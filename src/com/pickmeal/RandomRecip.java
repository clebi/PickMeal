...
public class RandomRecip extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// get shared data
		final ShareData data = (ShareData) getApplication();
		try {
		...
		final TextView nameTxt = (TextView) findViewById(R.id.title);
		nameTxt.setText(recip.getName());
		// get and display level of the recipe
		final ImageView levelImg = (ImageView) findViewById(R.id.levelimg);
		setImg(levelImg, recip.getLevel());
		// get and display cost of the recipe
		final ImageView costImg = (ImageView) findViewById(R.id.costimg);
		setImg(costImg, recip.getCost());
		// get and display all products needed by the recipe
		final TextView ingredientTxt = (TextView) findViewById(R.id.ingredient);
		final Vector<Product> prods = recip.getProdList();
		...
		final TextView howtoTxt = (TextView) findViewById(R.id.howto);
	 ...
	 * 
	 * @param source
	 *            where the image need to be set
	 * @param nb
	 *            level or cost of the recipe
	 */
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.action:
			final Intent again = new Intent(RandomRecip.this, RandomRecip.class);
			finish();
			startActivity(again);
			break;
		case R.id.back:
			final Intent home = new Intent(RandomRecip.this, Pickmeal.class);
			startActivity(home);
			break;
		}
	}
