...
public class AllRecip extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final SimpleAdapter mSchedule = new SimpleAdapter(getBaseContext(),
				listItem, R.layout.item_recip, new String[] { "title",
						"leveltxt", "levelimg", "couttxt", "coutimg" },
				new int[] { R.id.title, R.id.leveltxt, R.id.levelimg,
						R.id.couttxt, R.id.coutimg });
		...
		maListViewPerso.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> a, View v, int position,
				...
				final Intent intent = new Intent(AllRecip.this, Recipe.class);
