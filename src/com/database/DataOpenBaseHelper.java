...
public class DataOpenBaseHelper extends SQLiteOpenHelper {
	 ...
	 */
	public DataOpenBaseHelper(Context context, String dbName, String dbPath,
			int dbVersion) {
	 ...
	 * 
	 * @throws IOException
	 *             throw if database file can't be opened
	 */
	...
	public void copyDb() throws IOException {
		final BufferedInputStream in = new BufferedInputStream(myContext
				.getResources().openRawResource(R.raw.recipes));
